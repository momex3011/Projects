# Al-Nabk Council Mobile

Expo Go mobile version for the Al-Nabk City Civil Council website.
...
```powershell
cd path\to\ready_to_move_apps\al_nabak\mobile
npm.cmd install
```
...
```powershell
cd path\to\ready_to_move_apps\al_nabak\website
